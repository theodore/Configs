...
map <buffer> <F4> :up<Return>:se makeprg=lilypond\ \"%<\"<Return>:make<Return>:!timidity "%<.midi"<Return>
"
" <F5>  save & make
map <buffer> <F5> :up<Return>:se makeprg=lilypond\ \"%<\"<Return>:make<Return>
"
...
"
" <F9>  make
map <buffer> <F9> :up<Return>:se makeprg=make\ -k<Return>:make<Return>
"
" <F10> menu
